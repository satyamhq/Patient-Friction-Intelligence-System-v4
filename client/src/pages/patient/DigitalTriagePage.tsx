...
export const DigitalTriagePage: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-fade-in max-w-5xl mx-auto">
      ...
      {showEmergencyBanner && (
        <div className="flex items-start gap-4 p-4 rounded-2xl bg-rose-50 border-2 border-rose-300 shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 space-y-5">
          ...
          {step === 1 && (
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm space-y-4">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <p className={`text-xs font-bold ${selected ? 'text-teal-700' : 'text-slate-700'}`}>
                            {opt.label}
                          </p>
              ...
              {serviceNeeded && (
                <div>
                  <label htmlFor="service-note" className="block text-xs font-semibold text-slate-600 mb-1">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-slate-50/50 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/30 focus:border-teal-500 transition-all resize-none"
                  />
                </div>
              )}
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm space-y-4">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-2.5 px-4 rounded-xl border-2 border-teal-400 bg-teal-50 text-teal-700 text-xs font-bold flex items-center justify-center gap-2 hover:bg-teal-100 transition-all cursor-pointer disabled:opacity-50"
                >
                  {isLocLoading
              ...
              <div>
                <label htmlFor="location-manual" className="block text-xs font-semibold text-slate-600 mb-1">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-slate-50/50 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/30 focus:border-teal-500 transition-all"
                />
              ...
              {locationMode === 'gps' && coords.latitude && (
                <div className="flex items-center gap-2 text-xs text-teal-700 bg-teal-50 px-3 py-2 rounded-lg border border-teal-200">
              ...
              <div className="flex gap-2 pt-2">
                <button type="button" onClick={() => setStep(1)} className="flex-1 py-2.5 rounded-xl border border-slate-200 text-slate-600 text-xs font-semibold hover:bg-slate-50 transition-all cursor-pointer">
                  ← Back
                </button>
          ...
          {step === 3 && (
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm space-y-4">
                ...
                {TRAVEL_OPTIONS.map(opt => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className={`text-[11px] font-bold leading-tight ${selected ? 'text-teal-700' : 'text-slate-600'}`}>
                        {opt.label}
                      </p>
                    </button>
                  );
              ...
              <div className="flex gap-2 pt-2">
                <button type="button" onClick={() => setStep(2)} className="flex-1 py-2.5 rounded-xl border border-slate-200 text-slate-600 text-xs font-semibold hover:bg-slate-50 transition-all cursor-pointer">
                  ← Back
                </button>
          ...
          {step === 4 && (
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm space-y-4">
              ...
              {accessibilityNeeds.length > 0 && (
                <div className="text-xs text-teal-700 bg-teal-50 px-3 py-2 rounded-lg border border-teal-200 flex items-center gap-2">
              ...
              <div className="flex gap-2 pt-2">
                <button type="button" onClick={() => setStep(3)} className="flex-1 py-2.5 rounded-xl border border-slate-200 text-slate-600 text-xs font-semibold hover:bg-slate-50 transition-all cursor-pointer">
                  ← Back
                </button>
          ...
          {step === 5 && (
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm space-y-4">
              ...
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
                <h3 className="text-xs font-bold text-slate-700 uppercase tracking-wide">Your Search Summary</h3>
                <ul className="space-y-1 text-xs text-slate-600">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-teal-500 shrink-0" />
                    <span>Service: <strong className="text-slate-800">{serviceNeeded || '—'}</strong></span>
                  </li>
                  <li className="flex items-center gap-2">
                    <MapPin className="w-3.5 h-3.5 text-slate-400 shrink-0" />
                    <span>Location: <strong className="text-slate-800">{locationName || 'Not specified'}</strong></span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Car className="w-3.5 h-3.5 text-slate-400 shrink-0" />
                    <span>Travel: <strong className="text-slate-800">{travelMode}</strong></span>
                  </li>
                  {accessibilityNeeds.length > 0 && (
                    <li className="flex items-center gap-2">
                      <Accessibility className="w-3.5 h-3.5 text-slate-400 shrink-0" />
                      <span>Accessibility: <strong className="text-slate-800">{accessibilityNeeds.join(', ')}</strong></span>
                    </li>
                  )}
                  <li className="flex items-center gap-2">
                    <Calendar className="w-3.5 h-3.5 text-slate-400 shrink-0" />
                    <span>Appointment: <strong className="text-slate-800">{appointmentStatus}</strong></span>
                  </li>
                </ul>
              </div>

              <div className="flex gap-2 pt-2">
                <button type="button" onClick={() => setStep(4)} className="flex-1 py-2.5 rounded-xl border border-slate-200 text-slate-600 text-xs font-semibold hover:bg-slate-50 transition-all cursor-pointer">
                  ← Back
                </button>
                <button
                  type="button"
        ...
        <div className="lg:col-span-5 space-y-5">
          ...
          {!hasSearched && !isSearching && (
            <div className="bg-slate-50 rounded-2xl border border-dashed border-slate-300 p-6 space-y-4">
              <div className="w-12 h-12 rounded-xl bg-teal-50 flex items-center justify-center text-teal-600 mx-auto">
                <Navigation className="w-6 h-6" />
              </div>
              <div className="text-center">
                <h3 className="text-sm font-bold text-slate-800">How This Works</h3>
          ...
          {isSearching && (
            <div className="bg-white rounded-2xl border border-slate-200 p-8 text-center space-y-3 shadow-sm">
              ...
              <p className="text-sm font-semibold text-slate-700">Searching verified facilities...</p>
          ...
          {hasSearched && routingError && !isSearching && (
            <div className="bg-rose-50 rounded-2xl border border-rose-200 p-5 space-y-2">
              <div className="flex items-center gap-2 text-rose-700 font-bold text-sm">
                <AlertTriangle className="w-4 h-4" />
                Facility search unavailable
              </div>
              <p className="text-xs text-rose-600">{routingError}</p>
              <button
                type="button"
                onClick={handleSubmit}
                className="text-xs font-semibold text-rose-700 underline cursor-pointer hover:no-underline"
              >
                Try again
              </button>
            </div>
        ...
        <div ref={resultsRef} className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              {requestId && (
                <p className="text-[11px] text-slate-400 mt-0.5">Request ID: {requestId}</p>
              )}
            </div>
            <button
              type="button"
              onClick={handleSubmit}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-teal-700 bg-teal-50 border border-teal-200 hover:bg-teal-100 transition-all cursor-pointer"
            >
          ...
          {routingFactors.length > 0 && (
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 flex flex-wrap gap-2">
              {routingFactors.map((factor, i) => (
                <span key={i} className="text-[11px] text-slate-600 bg-white px-2.5 py-1 rounded-lg border border-slate-200">
                  {factor}
                </span>
              ))}
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {routedFacilities.map((item, idx) => {
              ...
              return (
                <div
                  key={fid || idx}
                  className={`bg-white rounded-2xl border-2 p-5 shadow-sm hover:shadow-md transition-all space-y-4 ${
                    isFirst ? 'border-teal-400' : 'border-slate-200'
                  }`}
                >
                  {/* Card Header */}
                  <div className="flex items-start gap-3">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${isFirst ? 'bg-teal-100' : 'bg-slate-100'}`}>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          {isFirst && (
                            <span className="text-[10px] font-bold uppercase tracking-wider text-teal-700 bg-teal-50 px-2 py-0.5 rounded-full border border-teal-200 mb-1 inline-block">
                              Best Match
                            </span>
                          )}
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="text-[11px] font-semibold px-2 py-1 rounded-lg bg-slate-100 text-slate-600 border border-slate-200">
                      {fac.type}
                    </span>
                    {item.distanceKm !== null ? (
                      <span className="text-[11px] font-semibold px-2 py-1 rounded-lg bg-blue-50 text-blue-700 border border-blue-200 flex items-center gap-1">
                        <Navigation className="w-3 h-3" />
                        {item.distanceKm} km away
                      </span>
                    ) : (
                      <span className="text-[11px] px-2 py-1 rounded-lg bg-slate-50 text-slate-400 border border-slate-200 italic">
                        Distance unavailable
                      </span>
                    )}
                    {fac.workingHours && (
                      <span className="text-[11px] px-2 py-1 rounded-lg bg-slate-50 text-slate-500 border border-slate-200 flex items-center gap-1">
                  ...
                  {item.routingReasons.length > 0 && (
                    <div className="space-y-1">
                      <p className="text-[11px] font-bold uppercase tracking-wide text-slate-500">Why this facility?</p>
                  ...
                  {item.accessibilityMatches.length > 0 && (
                    <div className="flex flex-wrap gap-1.5">
                      {item.accessibilityMatches.map((match, ai) => (
                        <span key={ai} className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-indigo-50 text-indigo-700 border border-indigo-200 flex items-center gap-1">
                  ...
                  <div className="flex gap-2 pt-1">
                    {fid ? (
                      ...
                      <span className="flex-1 py-2 px-3 rounded-xl bg-slate-100 text-slate-400 text-xs font-semibold text-center">
                        Details unavailable
                      </span>
                    )}
                    <a
                      ...
                      className="flex-1 py-2 px-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold flex items-center justify-center gap-1.5 border border-slate-200 transition-all"
                    >
                  ...
                  {fac.phone && (
                    <a
                      href={`tel:${fac.phone}`}
                      className="w-full py-2 px-3 rounded-xl border border-slate-200 text-slate-600 text-xs font-semibold flex items-center justify-center gap-1.5 hover:bg-slate-50 transition-all"
                    >
