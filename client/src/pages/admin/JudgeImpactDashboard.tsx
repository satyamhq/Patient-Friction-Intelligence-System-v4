    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 gap-2">
        {STAGES.map((s) => (
          ...
          >
            <span className={`text-[10px] font-black block ${activeStage === s.id ? 'text-purple-700' : 'text-slate-400'}`}>
              STAGE {s.step}
            </span>
            <strong className={`text-xs block mt-0.5 ${activeStage === s.id ? 'text-purple-900' : 'text-slate-700'}`}>
              {s.title}
            </strong>
          </button>
        ))}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-5 bg-white rounded-3xl border border-slate-200 shadow-sm space-y-2">
          ...
          <p className="text-3xl font-black text-slate-900">58m <span className="text-xs text-emerald-600 font-bold">(-38%)</span></p>
        ...
        <div className="p-5 bg-white rounded-3xl border border-slate-200 shadow-sm space-y-2">
          ...
          <p className="text-3xl font-black text-slate-900">88.4% <span className="text-xs text-blue-600 font-bold">(+42%)</span></p>
        ...
        <div className="p-5 bg-white rounded-3xl border border-slate-200 shadow-sm space-y-2">
          ...
          <p className="text-3xl font-black text-slate-900">81.2% <span className="text-xs text-purple-600 font-bold">(+31%)</span></p>
        ...
        <div className="p-5 bg-white rounded-3xl border border-slate-200 shadow-sm space-y-2">
          ...
          <p className="text-3xl font-black text-slate-900">142,500+ <span className="text-xs text-amber-600 font-bold">(+55%)</span></p>
      ...
      <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5">
          <Link
            ...
            className="p-4 rounded-2xl border border-slate-200 hover:border-teal-500 hover:shadow-md transition-all group flex items-start gap-3.5"
          >
            <div className="p-2.5 rounded-xl bg-teal-50 text-teal-600 group-hover:scale-105 transition-transform">
              <Users className="w-5 h-5" />
            </div>
            <div className="flex-1">
              <strong className="text-xs font-bold text-slate-900 group-hover:text-teal-600 transition-colors block">
          ...
          <Link
            to="/doctor/dashboard"
            className="p-4 rounded-2xl border border-slate-200 hover:border-blue-500 hover:shadow-md transition-all group flex items-start gap-3.5"
          >
          ...
          <Link
            ...
            className="p-4 rounded-2xl border border-slate-200 hover:border-indigo-500 hover:shadow-md transition-all group flex items-start gap-3.5"
          >
            <div className="p-2.5 rounded-xl bg-indigo-50 text-indigo-600 group-hover:scale-105 transition-transform">
              <Building2 className="w-5 h-5" />
            </div>
            <div className="flex-1">
              <strong className="text-xs font-bold text-slate-900 group-hover:text-indigo-600 transition-colors block">
          ...
          <Link
            to="/asha/dashboard"
            className="p-4 rounded-2xl border border-slate-200 hover:border-green-500 hover:shadow-md transition-all group flex items-start gap-3.5"
          >
            <div className="p-2.5 rounded-xl bg-green-50 text-green-600 group-hover:scale-105 transition-transform">
              <HeartHandshake className="w-5 h-5" />
            </div>
            <div className="flex-1">
              <strong className="text-xs font-bold text-slate-900 group-hover:text-green-600 transition-colors block">
          ...
          <Link
            ...
            className="p-4 rounded-2xl border border-slate-200 hover:border-purple-500 hover:shadow-md transition-all group flex items-start gap-3.5"
          >
          ...
          <Link
            to="/admin/dashboard"
            className="p-4 rounded-2xl border border-slate-200 hover:border-rose-500 hover:shadow-md transition-all group flex items-start gap-3.5"
          >
