      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm space-y-3">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 text-xs">
          ...
          <div className="p-3 bg-slate-50 rounded-xl">
            ...
            <strong className="text-slate-900 text-sm">{age} yrs • {gender}</strong>
          </div>
          <div className="p-3 bg-slate-50 rounded-xl">
          ...
          <div className="p-3 bg-slate-50 rounded-xl">
            ...
            <strong className="text-slate-900 text-sm">{pulse}</strong>
          </div>
          <div className="p-3 bg-slate-50 rounded-xl">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-sm space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-teal-500 text-slate-900 outline-none"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-teal-500 text-slate-900 outline-none font-semibold"
            />
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-sm space-y-4">
          ...
          <div className="space-y-3">
            {prescription.map((rx, idx) => (
              <div
                key={idx}
                className="grid grid-cols-1 sm:grid-cols-12 gap-2 p-3 bg-slate-50 rounded-xl border border-slate-100 items-center"
              >
          ...
          <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-sm space-y-3">
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              {labTests.map((test) => (
                <span
                  key={test}
                  className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-slate-100 text-slate-700"
                >
                  {test}
